 function drawLine(sourceElementID, targetElementID) {
     ...
     var sourceX = sourceElement.getBoundingClientRect().right;
     var sourceY = sourceElement.getBoundingClientRect().top;



     var targetX = targetElement.getBoundingClientRect().left;
 ...
 var divState = ["amazon", "assembly", "vanguard"]; // we store the status in this object
 var divStateweapon1 = ["biochemical", "laser", "firearms", "arc"];
 var currentRace = "";
 ...
 var divState2 = ["promethean", "synthesis"];
