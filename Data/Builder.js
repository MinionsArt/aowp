...
function showUnit(a) {
    ...
    for (i in jsonUnits.units) {
        if (a == jsonUnits.units[i].name) {
            ...
            //  unitName.innerHTML = "<span style='background-color: black'>" +
            //      "<span style='color:orange'>" + "/&nbsp" + "</span>" +
            //      jsonUnits.units[i].string.toUpperCase() +
            //     "</span>";
            // unitName.innerHTML = "test";
            ...
            if (jsonUnits.units[i].tier == "1") {
                tier.innerHTML = "Tier I: 3 <x-energy></x-energy>";
            ...
            if (jsonUnits.units[i].tier == "2") {
                tier.innerHTML = "Tier II: 8 <x-energy></x-energy>";
            ...
            if (jsonUnits.units[i].tier == "3") {
                tier.innerHTML = "Tier III: 12 <x-energy></x-energy>";
            ...
            if (jsonUnits.units[i].tier == "4") {
                tier.innerHTML = "Tier IV: 12 <x-energy></x-energy> 5 <x-cosmite></x-cosmite>";
                levelup.innerHTML = "<p><x-medal_trooper> </x-medal_trooper>Trooper<li>+6 <x-hp></x-hp> Hit Points</li></ul><p><x-medal_veteran> </x-medal_veteran>Veteran<li>+6 HP</li></ul><p>Expert<li>+6 HP</li></ul> <p>Elite<li>+6 HP</li><li>" + EliteSkill(jsonUnits.units[i].elite_skill) + "</li></ul>";
            }
